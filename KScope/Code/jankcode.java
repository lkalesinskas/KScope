...
//		String testline = "-0.08484338358458961,0.042204773869346734,-0.014306532663316582,0.016354690117252928,0.006238693467336681,-0.004764237855946398,0.008940536013400334~~>Bacterial_Cytoskeleton";
//		String[] testarr = testline.split("~~");
//		for(String arrval : testarr){
//			System.out.println(arrval);
//		}
//		String[] testCoordArr = testarr[0].split(",");
//		for(String coordval : testCoordArr){
//			System.out.println(coordval + " " + Double.valueOf(coordval));
//		}
		
		BufferedReader missReader = new BufferedReader(new FileReader("3mer misses"));
		ArrayList<String> trainArray = new ArrayList<String>();
		
		RandomAccessFile trainReader = new RandomAccessFile(new File("TrainOut63mer.fasta"), "r");
		String line2 = "";
		int count2 = 0;
		String targetID = "";
		long pos = 0;
		...
		while((line2 = missReader.readLine()) != null){
			String[] misses = line2.split(">");
			for(String str : misses){
				trainArray.add(">"+str);
			}
		}
		
		System.out.println("size: " + trainArray.size());
		...
		HashMap<double[], Boolean> testMap = new HashMap<double[], Boolean>();
		...
		testMap.put(test1, Boolean.TRUE);
		for(double[] key : testMap.keySet()){
//			System.out.println(Arrays.equals(key, test2));
		}
	}
